...
using EthereumSamurai.Models.Debug;
using EthereumSamurai.Services.Models.Debug;
...
namespace EthereumSamurai.Services
{
    public class DebugDecorator : IDebug
    {
        ...
        public async Task TraceTransactionAsync(string transactionHash, bool withMemory, bool withStack, bool withStorage)
        {
        ...
        public async Task TraceTransactionAsync(string fromAddress, string toAddress, BigInteger value,
