...
{
    /// <summary>
    ///     This class represents an Error log event.
    /// </summary>
    public sealed class LykkeError : LykkeLogEvent
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="LykkeError" /> class.
        /// </summary>
        ...
        /// </param>
        /// <inheritdoc />
        public LykkeError(string logSource, Type logClass, string message, long? duration, string process,
